...
(function($) {
    ...
    var _attr = {};
		...
		this.setInternal = function(data) {
			...
			var _data = ($.isPlainObject(_internals[pluginName+"_"+id]))
				? _internals[pluginName+"_"+id]
				: {};
		...
		this.getInternal = function(key) {
			return ($.isPlainObject(_internals[pluginName+"_"+id]))
				? _internals[pluginName+"_"+id][key]
				: undefined;
		}
    ...
    this.animate = function(properties, duration, animation) {
